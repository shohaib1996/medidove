...
const priceing_data: PricingItem[] = [
  {
    ...
    title: "Professional",
    sm_des: "Website, appointment capture, contact requests, and a focused staff dashboard for small clinics.",
  ...
  },
  {
    ...
    title: "Advanced",
    sm_des: "Adds website assistance, smart intake routing, improved search, and reminder workflows.",
  ...
  },
  {
    ...
    title: "Premium",
    sm_des: "Includes voice reception, phone reminders, outreach automation, analytics, and launch support.",
